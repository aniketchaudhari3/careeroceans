...
<p>CareerOceans ("us", "we", or "our") operates the careeroceans.cf website (the "Service").</p>

<p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our
    Service and the choices you have associated with that data. Our Privacy Policy for CareerOceans is created with the
    help of the https://www.freeprivacypolicy.com Free Privacy Policy website</a>.</p>
...
<p>We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of
    ...
    Privacy Policy have the same meanings as in our Terms and Conditions, accessible from careeroceans.cf</p>
...
<p>CareerOceans uses the collected data for various purposes:</p>
<ul>
...
<p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement to that
    transfer.</p>
<p>CareerOceans will take all steps reasonably necessary to ensure that your data is treated securely and in accordance
...
<p>CareerOceans may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
<ul>
    <li>To comply with a legal obligation</li>
    <li>To protect and defend the rights or property of CareerOceans</li>
...
<ul>
    <li>By visiting this page on our website: careeroceans.cf/contact</li>
